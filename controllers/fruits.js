...
const index = async (req, res) => {
    try { // The index function is an asynchronous function that handles the request and response for the route. It uses a try-catch block to handle any errors that may occur during the execution of the function.
